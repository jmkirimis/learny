 ...
 * @author João
 */
public class FFaseNumeros3 extends javax.swing.JFrame {

    /**
     * Creates new form FFaseNumeros1
     */
    public FFaseNumeros3() {
        initComponents();
    }
    ...
    private void panelSombra5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelSombra5MouseClicked
        JOptionPane.showMessageDialog(null, "Que pena! A resposta era 18");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FFaseNumeros3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
